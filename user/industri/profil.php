            ...
            <div class="content">
                <div class="card border-black rounded-4 d-flex flex-row justify-content-center align-items-center mx-5 my-4 pt-lg-2 ps-4 pe-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-center text-start">
                        <h5 class="fw-semibold mb-3 mt-2">Nasywa Salma Salsabila</h5>
                        <p class="fw-normal">Industri</p>
                        <p class=" role fw-light">Mitra Industri Politeknik Negeri Malang</p>
                    </div>
                        ...
                        <div class="container">
                            <div class="row mb-4">
                                <div class="col-4">
                                    ...
                                    <p class="fw-medium">Nasywa</p>
                                </div>
                                <div class="col-4">
                                    <p class="identity mb-2">Nama belakang</p>
                                    <p class="fw-medium">Salma Salsabila</p>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-4">
                                    <p class="identity mb-2">Perusahaan</p>
                                    <p class="fw-medium">2241760135</p>
                                </div>
                                <div class="col-4">
                                    <p class="identity mb-2">Posisi</p>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <p class="fw-medium">0895 8097 72288</p>
                                </div>
                                <div class="col-4">
                                    <p class="identity mb-2">Email</p>
                                    <p class="fw-medium">naswasalma@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
