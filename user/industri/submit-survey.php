...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($survey_kategori_page) {
        case 'soal-kerjasama-kolaborasi.php':
            $survey_kategori_id = 14;
            break;
        case 'soal-kualitas-lulusan.php':
            $survey_kategori_id = 16;
            break;
        case 'soal-magang-praktikkerja.php':
            $survey_kategori_id = 15;
            break;
        default:
