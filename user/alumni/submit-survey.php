...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($survey_kategori_page) {
        case 'soal-jaringan-alumni.php':
            $survey_kategori_id = 11;
            break;
        case 'soal-kualitas-pendidikan.php':
            $survey_kategori_id = 8;
            break;
        case 'soal-pengembangan-karir.php':
            $survey_kategori_id = 10;
            break;
        case 'soal-proses-administrasi.php':
            $survey_kategori_id = 9;
            break;
        default:
