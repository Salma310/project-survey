...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($survey_kategori_page) {
        case 'soal-fasilitas-akademik.php':
            $survey_kategori_id = 17;
            break;
        case 'soal-pengembangan-profesional.php':
            $survey_kategori_id = 18;
            break;
        default:
    ...
    if ($result_survey) {
        ...
        foreach ($_POST as $key => $value) {
            if (strpos($key, 'pertanyaan') === 0) {
                ...
                // Masukkan jawaban ke tabel t_jawaban_tendik
                ...
                if ($result_jawaban) {
                    echo "Jawaban untuk soal $soal_id berhasil dimasukkan ke t_jawaban_tendik!<br>";
                } else {
