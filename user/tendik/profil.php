            ...
            <div class="content">
                <div class="card border-black rounded-4 d-flex flex-row justify-content-center align-items-center mx-5 my-4 pt-lg-2 ps-4 pe-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-center text-start">
                        <h5 class="fw-semibold mb-3 mt-2">Doni Wahyu</h5>
                        <p class="fw-normal">Tendik</p>
                        <p class=" role fw-light">Tendik Politeknik Negeri Malang</p>
                    </div>
                        ...
                        <div class="container">
                            <div class="row mb-4">
                                <div class="col-4">
                                    ...
                                    <p class="fw-medium">Doni</p>
                                </div>
                                <div class="col-4">
                                    <p class="identity mb-2">Nama belakang</p>
                                    <p class="fw-medium">Wahyu</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                    <p class="identity mb-2">Nomor Pegawai</p>
                                    <p class="fw-medium">199209262017051001</p>
                                </div>
                                <div class="col-4">
                                    <p class="identity mb-2">Unit</p>
                                    <p class="fw-medium">Tenaga Honorer</p>
                                </div>
                            </div>
                        </div>
                    </div>
