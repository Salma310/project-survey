...
$first_name = $last_name = $email = $no_hp = $city = $country = "";
$profileComplete = $dashboard->checkProfileCompletion($first_name, $last_name, $email, $phone_number, $tahun_masuk, $prodi, $nim, $gender, $city, $country);
        ...
        <div class="main">
            <div class=" header d-flex justify-content-between ms-5 mt-4 mb-4 me-4">
                <div class="header-info">
                    ...
                    <p class="desc mb-3">Cuplikan dari detail-detail penting</p>
                </div>
                <a href="profile.php">
